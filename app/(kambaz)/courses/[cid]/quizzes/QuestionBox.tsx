...
export default function QuestionBox({ givenQuestion, index, questions, setQuestions } : 
    { givenQuestion: any, index: number, questions: any[], setQuestions: (question: any) => void }) {
