...
export default function WorkingWithArrays() {
  ...
  return (
    ...
    Update Todo Id and Title</a>
    <FormControl defaultValue={todo.id} className="w-25 me-2 float-start"
    onChange={(e) => setTodo({ ...todo, id: e.target.value })}/>
    ...
    <FormCheck className="w-50" type="checkbox" checked={todo.completed}
